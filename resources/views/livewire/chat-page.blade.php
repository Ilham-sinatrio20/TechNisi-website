            ...
            <div class="row g-0">
				...
				<div class="col-12 col-lg-7 col-xl-9 chat-box">
						...
						<div class="chat-messages p-4" id="content_to_scroll">
                            @if ($messages->count())
                             @foreach ($messages as $chat)
                                @if ($chat->sender == Auth::user()->id && $chat->receiver == $receiver)
                                <div class="chat-message-right pb-4">
                                    ...
                                    @else
                                    <div>
                                        <img src="https://source.unsplash.com/40x40?person" class="rounded-circle mr-1" alt="{{ Auth::user()->name }}" width="40" height="40">
                                ...
                                @elseif($chat->sender == $receiver && $chat->receiver == Auth::user()->id)
                    ...
                    <div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							<div class="position-relative">
								<img src="https://source.unsplash.com/40x40?person" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
							</div>
							<div class="flex-grow-1 pl-3">
