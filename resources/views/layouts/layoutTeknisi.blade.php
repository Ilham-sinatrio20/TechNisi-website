                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="navbar navbar-expand-lg bg-light navbar-light">
                                ...
                                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                    ...
                                    <a href="{{ route('teknisi.index') }}" class="nav-item nav-link {{ ($title == 'Home') ? 'active' : '' }}">Home</a>

                                    @guest
                                        @if (Route::has('login'))
                                            <a href="{{ route('teknisi.detailOrder') }}" class="nav-item nav-link {{ ($title == 'DetailOrder') ? 'active' : '' }}">Detail Order</a>
                                            <a href="{{ route('inbox.index') }}" class="nav-item nav-link {{ ($title == 'Chat') ? 'active' : '' }}">Chat</a>
                                            <a href="" class="nav-item nav-link {{ ($title == 'Profil') ? 'active' : '' }}">Profil</a>
